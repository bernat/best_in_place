...
function BestInPlaceEditor(e) {
    ...
    jQuery(this.activator).bind(self.action, {editor: this}, this.clickHandler);
}
...
BestInPlaceEditor.prototype = {
    ...
    activate: function () {
        ...
        jQuery(this.activator).unbind(this.action, this.clickHandler);
        this.activateForm();
    ...
    abort: function () {
        ...
        jQuery(this.activator).bind(this.action, {editor: this}, this.clickHandler);
    ...
    initOptions: function () {
        ...
        self.action = self.element.data("bipAction") || 'click';
