...
BestInPlaceEditor.prototype = {
  ...
  initOptions : function() {
    ...
    self.element.parents().each(function(){
      ...
      self.objectAttributes  = self.objectAttributes  || $parent.attr("data-object-attributes");
    });
    ...
    self.objectAttributes  = self.element.attr("data-object-attributes")   || self.objectAttributes;
  ...
  requestData : function() {
    ...
    if (this.objectAttributes) {
      data += "_method=post";
      var that = this, value;
      $.each(JSON.parse(that.objectAttributes), function(attr, val) {
        value = (attr === that.attributeName) ? encodeURIComponent(that.getValue()) : val;
        if (value) {
          data += "&" + that.objectName + '[' + attr + ']=';
          data += (attr === that.attributeName) ? encodeURIComponent(that.getValue()) : value;
        }
      });
    } else {
      data += "_method=put";
