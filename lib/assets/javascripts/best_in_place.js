...
BestInPlaceEditor.prototype = {
  ...
  initOptions : function() {
    ...
    self.element.parents().each(function(){
      ...
      self.activeSpanClass   = self.activeSpanClass   || $parent.attr("data-active-span-class");
    });
    ...
    self.activeSpanClass   = self.element.attr("data-active-span-class")   || self.activeSpanClass || "best_in_place_active";
...
BestInPlaceEditor.forms = {
  ...
  "textarea" : {
    activateForm : function() {
      ...
      this.element.html(output);
      this.element.addClass(this.activeSpanClass);
      this.setHtmlAttributes();          
    ...
    blurHandler : function(event) {            
      ...
      event.data.editor.element.removeClass(event.data.editor.activeSpanClass);      
    },
