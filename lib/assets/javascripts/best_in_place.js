...
BestInPlaceEditor.prototype = {
  ...
  update : function() {
    var editor = this;
    var input_types = {color: 1, date: 1, datetime: 1, 'datetime-local': 1, email: 1, month: 1, number: 1, range: 1, search: 1, tel: 1, time: 1, url: 1, week: 1, input: 1, textarea:1};
    if (this.formType in input_types && this.getValue() == this.oldValue)
  ...
  bindForm : function() {
    form = BestInPlaceEditor.forms[this.formType] || BestInPlaceEditor.forms['input'];
    this.activateForm = form.activateForm;
...
BestInPlaceEditor.forms = {
  "input" : {
    activateForm : function() {
      ...
      this.element.find("input[type='"+this.formType+"']")[0].select();
