  ...
  initOptions : function() {
    ...
    self.element.parents().each(function(){
      ...
      self.html_attrs    = self.html_attrs    || jQuery(this).attr("data-html-attrs");
			this.setValue		   = this.setValue			|| jQuery(this).attr("data-value");
    ...
    self.html_attrs    = self.element.attr("data-html-attrs")    || self.html_attrs;
		this.setValue			 = self.element.attr("data-value")				 || this.setValue;
  ...
  "select" : {
    activateForm : function() {
      ...
      $.each(this.values, function(index, value) {
				var regex = new RegExp(value[1] + ' - ', 'i');
				var assert = regex.test(oldValue);
				if (assert==true) {
					selected = "selected='selected'";
				} else {
					selected = ((value[1] == oldValue || value[0] == oldValue)? "selected='selected'" : "");
				}
